...
export const initialColumns: Column<DataItem>[] = [
  { id: "account", header: "Account", accessor: "account", isDraggable: true, isRemovable: true, isVisible: true, width: 110 },
  { id: "orderNr", header: "Order Nr", accessor: "orderNr", isDraggable: true, isRemovable: true, isVisible: true, width: 100 },
  { id: "customer", header: "Customer", accessor: "customer", isDraggable: true, isRemovable: true, isVisible: true, width: 120 },
  { id: "name", header: "Name", accessor: "name", isDraggable: true, isRemovable: true, isVisible: true, width: 150 },
  { id: "program", header: "Program", accessor: "program", isDraggable: true, isRemovable: true, isVisible: true, width: 200 },
  { id: "platform", header: "Platform", accessor: "platform", isDraggable: true, isRemovable: true, isVisible: true, width: 120 },
  { id: "platformStatus", header: "Platform Status", accessor: "platformStatus", isDraggable: true, isRemovable: true, isVisible: true, width: 130 },
  { id: "email", header: "Email", accessor: "email", isDraggable: true, isRemovable: true, isVisible: true, width: 180 },
  { id: "country", header: "Country", accessor: "country", isDraggable: true, isRemovable: true, isVisible: true, width: 120 },
  { id: "type", header: "Type", accessor: "type", isDraggable: true, isRemovable: true, isVisible: true, width: 100 },
  { id: "serverGroup", header: "Server Group", accessor: "serverGroup", isDraggable: true, isRemovable: true, isVisible: true, width: 120 },
  { id: "balance", header: "Balance", accessor: "balance", isDraggable: true, isRemovable: true, isVisible: true, width: 110 },
  { id: "equity", header: "Equity", accessor: "equity", isDraggable: true, isRemovable: true, isVisible: true, width: 110 },
  { id: "growth", header: "Growth", accessor: "growth", isDraggable: true, isRemovable: true, isVisible: true, width: 110 },
  { id: "pnl", header: "PnL", accessor: "pnl", isDraggable: true, isRemovable: true, isVisible: true, width: 100 },
  { id: "level", header: "Level", accessor: "level", isDraggable: true, isRemovable: true, isVisible: true, width: 90 },
  { id: "softBreaches", header: "Soft Breaches", accessor: "softBreaches", isDraggable: true, isRemovable: true, isVisible: false, width: 120 },
  { id: "copyTrading", header: "Copy Trading", accessor: "copyTrading", isDraggable: true, isRemovable: true, isVisible: false, width: 120 },
  { id: "hedgeTrading", header: "Hedge Trading", accessor: "hedgeTrading", isDraggable: true, isRemovable: true, isVisible: false, width: 130 },
  { id: "ipCount", header: "IP Count", accessor: "ipCount", isDraggable: true, isRemovable: true, isVisible: false, width: 100 },
  { id: "avgLoss", header: "Avg. Loss", accessor: "avgLoss", isDraggable: true, isRemovable: true, isVisible: false, width: 110 },
  { id: "avgWin", header: "Avg. Win", accessor: "avgWin", isDraggable: true, isRemovable: true, isVisible: false, width: 110 },
  { id: "dailyStopOutBar", header: "Daily Stop Out Bar", accessor: "dailyStopOutBar", isDraggable: true, isRemovable: true, isVisible: false, width: 140 },
  { id: "overallStopOutBar", header: "Overall Stop Out Bar", accessor: "overallStopOutBar", isDraggable: true, isRemovable: true, isVisible: false, width: 150 },
  { id: "maxWithdrawal", header: "Max Withdrawal", accessor: "maxWithdrawal", isDraggable: true, isRemovable: true, isVisible: false, width: 130 },
  { id: "targetEquityBar", header: "Target Equity Bar", accessor: "targetEquityBar", isDraggable: true, isRemovable: true, isVisible: false, width: 140 },
  { id: "hwmBalance", header: "HWM Balance", accessor: "hwmBalance", isDraggable: true, isRemovable: true, isVisible: false, width: 120 },
  { id: "daysSinceDeposit", header: "Days Since Deposit", accessor: "daysSinceDeposit", isDraggable: true, isRemovable: true, isVisible: false, width: 140 },
  { id: "activeTradingDays", header: "Active Trading Days", accessor: "activeTradingDays", isDraggable: true, isRemovable: true, isVisible: false, width: 150 },
  { id: "inactiveTradingDays", header: "Inactive Trading Days", accessor: "inactiveTradingDays", isDraggable: true, isRemovable: true, isVisible: false, width: 160 },
  { id: "firstTradeDate", header: "First Trade Date", accessor: "firstTradeDate", isDraggable: true, isRemovable: true, isVisible: false, width: 130 },
  { id: "daysSinceFirstTrade", header: "Days Since First Trade", accessor: "daysSinceFirstTrade", isDraggable: true, isRemovable: true, isVisible: false, width: 160 },
  { id: "lwmAllTrades", header: "LWM All Trades", accessor: "lwmAllTrades", isDraggable: true, isRemovable: true, isVisible: false, width: 130 },
  { id: "consistencyBestWorstDay", header: "Consistency: Best & Worst Day Profit", accessor: "consistencyBestWorstDay", isDraggable: true, isRemovable: true, isVisible: false, width: 220 },
